...
/**
 * Método que se utiliza para mostrar el historial de partidas de La Mansión Zombie.
 * 
...
//		this.mostrarInterfaz();
	...
	/**
	 * Método que contiene el diseño de la interfaz del historial.
	 */
	...
	/**
	 * Método que se usa para leer la información del archivo que se usa para guardar el historial.
	 * 
	 * @param rutaFichero Cadena que almacena la ruta del fichero.
	 */
