...
/**
 * Clase que contiene la lógica del juego y su apartado visual.
 * 
...
public class Juego extends  JDialog implements ActionListener, WindowListener, Serializable  {
    ...
    /**
     * Devuelve el número total de habitaciones en el escenario del juego.
     *
     * @return El número total de habitaciones.
     */
	...
	/**
	 * Establece el número total de habitaciones en el escenario del juego.
	 *
	 * @param numeroHabitacionTotal El número total de habitaciones a establecer.
	 */
	...
	/**
	 * Devuelve el número de intentos de búsqueda realizados en el juego.
	 *
	 * @return El número de intentos de búsqueda.
	 */
	...
	/**
	 * Establece el número de intentos de búsqueda realizados en el juego.
	 *
	 * @param intentosBusqueda El número de intentos de búsqueda a establecer.
	 */
	...
	/**
	 * Devuelve el número de la habitación actual en la que se encuentra el jugador.
	 *
	 * @return El número de la habitación actual.
	 */
	...
	/**
	 * Establece el número de la habitación actual en la que se encuentra el jugador.
	 *
	 * @param habitacionActual El número de la habitación actual a establecer.
	 */
	...
	/**
	 * Devuelve el número de zombies activos en el juego.
	 *
	...
	/**
	 * Establece el número de zombies activos en el juego.
	 *
	 * @param numeroZombiesActivos El número de zombies activos a establecer.
	 */
	 ...
	 *
	 * @param estadoPartida El estado de la partida a establecer.
	 */
	 ...
	 *
	 * @param dificultad La dificultad del juego a establecer.
	 */
...
//		this.mostrarInterfaz();
	...
	/**
	 * Método que contiene el apartado visual de la clase Juego.
	 */
	...
	/**
	 * Método que se encarga de definir el formato de los JTextField en la clase Juego.
	 * 
	 * @param textField JTextField que será formateado.
	 */
	...
	/**
	 * Método que se encarga de definir el formato de los Botones en la clase Juego.
	 * 
	 * @param btn botón que será formateado.
	 */
	...
	/**
	 * Método que se encarga de definir el formato de los campos de texto en la clase Juego.
	 * @param lbl
	 */
	...
	/**
	 * Método que se encarga de actualizar la imagen de fondo.
	 */
     ...
     * 
     * @param estado Enum que representa el estado de la partida.
     */
	...
	/**
	 * Método que se encarga de la funcionalidad del combate y su resultado.
	 */
	public void combate() {
		if(getNumeroZombiesActivos() > 0) {
            ...
            if (estado == EstadoCombate.VICTORIA) {
            	...
            	// Asignar el estado de la partida a derrota.
            	this.estadoPartida = EstadoPartida.DERROTA;
            	//Guardar en el historial.
            	guardarHistorial(RUTA_HISTORIAL,true);
            	// Mostrar pantalla de derrota.
            	PantallaFinal pDerrota = new PantallaFinal(this,estadoPartida);
	...
	/**
	 * Método que se encarga de habilitar o deshabilitar botones según el momento de la partida.
	 */
	...
	/**
	 * Método que se encarga de controlar la navegación del jugador por la mansión y su correspondiente victoria
	 * en caso de superar las habitaciones máximas.
	 */
	public void avanzar() {
		if(habitacionActual < numeroHabitacionTotal) {
			...
			guardarHistorial(RUTA_HISTORIAL,true);
			// Imagen de victoria
			PantallaFinal pVictoria = new PantallaFinal(this, estadoPartida);
	...
	/**
	 * Método que gestiona los resultados aleatorios de las busquedas realizadas por el jugador y
	 * sus respectivos efectos en la partida.
	 */
	public void buscar() {
	...
	/**
	 * Método que se encarga de guardar la partida en el momento actual.
	 * 
	 * @param rutaFichero Ruta del fichero en el que se guarda la información.
	 */
	...
	/**
	 * Método que se encarga de guardar el resutado de la partida en el historial.
	 * 
	 * @param rutaHistorial Ruta del fichero en el que se guarda la información.
	 * @param apend Booleano que determina si se sobreescribe en el fichero o no (en este caso no).
	 */
