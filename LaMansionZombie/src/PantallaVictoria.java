...
public class PantallaVictoria extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			...
			PantallaVictoria dialog = new PantallaVictoria(padre);
	 ...
	 * Create the dialog.
	 */
	public PantallaVictoria(JDialog dialog) {
		super(dialog, true);
//		mostrarInterfaz();
	}
	...
	public void mostrarInterfaz() {
		...
		JLabel lblVictoria = new JLabel("Has escapado de la mansión");
		...
		lblVictoria.setBounds(69, 79, 405, 35);
